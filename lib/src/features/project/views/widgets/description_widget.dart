...
class DescriptionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    void showDeleteDescriptionDialog() {
      showDialog(
        context: context,
        builder: (_) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                await projectC.patchProject(id: project.id, description: '');
              ...
              child: Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      IconButton(
                        onPressed: showEditDescriptionDialog,
                        icon: const Icon(Icons.edit),
                      ),
                      IconButton(
                        onPressed: showDeleteDescriptionDialog,
